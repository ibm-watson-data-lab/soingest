...
./Bluemix_CLI/bin/bluemix wsk rule update so_couchdbrule so_couchdbish stackoverflow/socron
...
./Bluemix_CLI/bin/bluemix wsk rule update so_composerule so_compose stackoverflow/socron
...
./Bluemix_CLI/bin/bluemix wsk rule update so_sparkrule so_spark stackoverflow/socron
...
./Bluemix_CLI/bin/bluemix wsk rule update so_jupyterrule so_jupyter stackoverflow/socron
